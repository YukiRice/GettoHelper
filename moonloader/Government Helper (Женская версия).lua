...
imgui.Separator()
	  ...
	  if imgui.Button(u8"Приветствие") then
			...
			wait(1500)
			sampSendChat("Я действующая " ..mainIni.config.rank.. ".")
			wait(1500)
...
function cmd_givepass(arg)
	...
	then
        ...
        lua_thread.create(function()
        sampSendChat("/me достала чистый бланк из под стола")
        wait(1400)
        sampSendChat("/me достала ручку и начала заполнять документы")
        wait(1400)
        sampSendChat("/do Бланк документов заполнен.")
        wait(1400)
        sampSendChat("/me положила бланки в папку и передала человеку паспорт")
        wait(1)
	...
	function cmd_invite(arg)
		...
		then
	        ...
	        lua_thread.create(function()
	        sampSendChat("/me достала планшет из сумки")
	        wait(1400)
	        sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
	        wait(1400)
	        sampSendChat("/me зашла в раздел 'Сотрудники' и нажала на кнопку 'Добавить сотрудника' ")
	        wait(1400)
	        sampSendChat("/do Данные о сотруднике занесены.")
					wait(1400)
		      sampSendChat("/me выключила планшет и убрала его в карман")
					wait(1400)
		...
		function cmd_uninvite(arg)
				...
				then
						...
						sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
						wait(1400)
						sampSendChat("/me зашла в раздел 'Сотрудники' и нажала на кнопку 'Удалить сотрудника' ")
						wait(1400)
			...
			function cmd_fwarn(arg)
					...
					then
							...
							sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
							wait(1400)
							sampSendChat("/me зашла в раздел 'Сотрудники' и нажала на кнопку 'Выдать выговор' ")
							wait(1400)
				...
				function cmd_unfwarn(arg)
						...
						then
								...
								sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
								wait(1400)
								sampSendChat("/me зашла в раздел 'Сотрудники' и нажала на кнопку 'Снять выговор' ")
								wait(1400)
								sampSendChat("/do Данные о сотруднике изменены.")
								wait(1400)
								sampSendChat("/me выключила планшет и убрала его в карман")
					...
					function cmd_blacklist(arg)
							...
							then
									...
									sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
									wait(1400)
									sampSendChat("/me зашла в раздел 'Чёрный список' и нажала на кнопку 'Добавить человека в список' ")
									wait(1400)
						...
						function cmd_unblacklist(arg)
								...
								then
										...
										sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
										wait(1400)
										sampSendChat("/me зашла в раздел 'Чёрный список' и нажала на кнопку 'Удалить человека из списка' ")
										wait(1400)
							...
							function cmd_unblacklistoff(arg)
								...
								function cmd_fmute(arg)
										...
										then
												...
												sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
												wait(1400)
												sampSendChat("/me зашла в раздел 'Рации сотрудников' и нажала на кнопку 'Выключить рацию сотруднику' ")
												wait(1400)
									...
									function cmd_funmute(arg)
											...
											then
													...
													sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
													wait(1400)
													sampSendChat("/me зашла в раздел 'Рации сотрудников' и нажала на кнопку 'Включить рацию сотруднику' ")
													wait(1400)
													sampSendChat("/do Данные о рации сотрудника были изменены.")
													wait(1400)
													sampSendChat("/me выключила планшет и убрала его в карман")
										...
										function cmd_fmutes(arg)
											...
											function cmd_giverank(arg)
													...
													then
															...
															sampSendChat("/me включила планшет и зашла в приложение 'Правительство' ")
															wait(1400)
															sampSendChat("/me зашла в раздел 'Сотрудники' и нажала на кнопку 'Должности' ")
															wait(1400)
															sampSendChat("/me изменила данные о сотруднике")
															wait(1400)
